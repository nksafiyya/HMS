...
<head>
	...
	<title>HMS | Applicants for the job <?php echo "$job_title"; ?></title>
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="../marshals.php">marshals</a>
							</li>
				...
				<div class="container">
					...
					<div class="marshal-grid-wrapper">
						...
						<div class="GridLex-gap-15-wrappper">
							...
							$stmtb = $conn->prepare("SELECT * FROM users WHERE role = 'marshal' AND member_no = '$emp_id'");
                            $stmtb->execute();
							...
							
							{
								...
								?>
									...
									<div class="marshal-grid-item">
										...
										<a target="_blank" href="../marshal-detail.php?empid=<?php echo $rowb['member_no']; ?>" class="clearfix">
