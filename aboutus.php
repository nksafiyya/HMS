						...
						<div class="GridLex-grid-middle">
							...
							<div class="GridLex-col-3_sm-12_xs-12">
								...
								<div class="sorting-header">
									<h3 class="sorting-title">About Us</h3>
								</div>
						...
						<div class="GridLex-gap-30">
                            ...
                            $total_records++;
	                        ...
	                        }catch(PDOException $e)
                             {
								...
								print '<li class="paging-nav" '; if ($page == "1") { print 'class="disabled"'; } print '><a '; if ($page == "1") { print ''; } else { print 'href="aboutus.php?page='.$prevpage.'"';} print '><i class="fa fa-chevron-left"></i></a></li>';
					            for ($b=1;$b<=$records;$b++)
                                 {
                                 
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#33B6CB; color:white" '; } ?>  href="aboutus.php?page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a></li><?php
                                 }	
								 print '<li class="paging-nav"'; if ($page == $records) { print 'class="disabled"'; } print '><a '; if ($page == $records) { print ''; } else { print 'href="aboutus.php?page='.$nextpage.'"';} print '><i class="fa fa-chevron-right"></i></a></li>';
					             }
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											...
											<li><a href="marshals.php">marshals</a></li>
